<template>
    <v-container>
        <v-card
            ...
            <v-list-item-content>
                <v-list-item-title class="headline">Stream Namespace Primary</v-list-item-title>
...
const config = {
  ...
  export default {
    ...
    methods: {
        ...
        play() {
            this.socket = io.connect('http://localhost:3000/primary', {reconnect: true, transports: ['websocket']})
            this.socketInit();
        },
        stop() {
